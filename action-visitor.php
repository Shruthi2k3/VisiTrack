              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="visid" id="visid" value="<?php  echo $row['VisiterId'];?>" readonly>
                  </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>Photo</label>
                        <img src="<?php echo $row['Image']; ?>" alt="Visitor Image" style="width:300px;height:200px;">
                    </div>
