...
(1, 'Shruthi', 'Shruthi', 1010, 9123456789, 'Shruthi@mail.com', '0192023a7bbd73250516f069df18b500', '2024-04-21 03:35:37');
...
CREATE TABLE `tblvisitor` (
  ...
  `VisiterId` bigint(11) DEFAULT NULL,
  `MobileNumber` bigint(11) DEFAULT NULL,
...
INSERT INTO `tblvisitor` (`ID`, `VisitorName`,`VisiterId`, `MobileNumber`, `Address`, `Gender`, `Apartment`, `BuildingNo`, `WhomtoMeet`, `Reason`, `EnterDate`, `remark`, `outtime`) VALUES
(17,'Abigal' ,'46859464649', 912354789, 'Sample Address', 'Female', '623', '        A    ', 'The Owner', 'Sample Business', '2024-06-17 07:31:35', NULL, NULL);
