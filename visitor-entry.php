<?php
    ...
    if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != "") {
      ...
      if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
          $query = mysqli_query($con, "INSERT into tblvisitor (VisitorName, VisiterId, MobileNumber, Address, Gender, Apartment, BuildingNo, WhomtoMeet, Reason, Image) 
                                       values ('$visname', '$visid', '$contactnumber', '$address', '$gender', '$apartmentno', '$buildingno', '$whomtomeet', '$reason', '$target_file')");

          if ($query) {
              $msg = "Visitor entry details have been added";
          } else {
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="visid" id="visid" required>
                  </div>
            ...
            <center><button type="submit" class="btn btn-sm btn-primary rounded-0" name="submit" onclick="return validateMobileNumber();">Save Entry</button></center>
            </div>
          </div>
          </form>
